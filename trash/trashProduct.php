<div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form class="xl:flex sm:mr-auto" id="tabulator-html-filter-form">
                ...
                <div class="items-center mt-2 sm:flex sm:mr-4 xl:mt-0">
                    ...
                    <input type="text" class="w-full mt-2 border input sm:w-40 xxl:w-full sm:mt-0"
                        id="tabulator-html-filter-value" placeholder="Busqueda...">
                </div>
                <div class="mt-2 xl:mt-0">
                    <button type="button" class="w-full text-white button sm:w-16 bg-theme-1"
                        id="tabulator-html-filter-go">Buscar</button>
                    <button type="button"
                        class="w-full mt-2 text-gray-600 bg-gray-200 button sm:w-16 sm:mt-0 sm:ml-1 dark:bg-dark-5 dark:text-gray-300"
                        id="tabulator-html-filter-reset">Reset</button>
                </div>
            </form>
            <div class="flex mt-5 sm:mt-0">
                ...
                <div class="w-1/2 dropdown sm:w-auto">
                    <button
                        class="flex items-center w-full text-gray-700 border dropdown-toggle button sm:w-auto dark:bg-dark-5 dark:text-gray-300">
                        <i data-feather="file-text" class="w-4 h-4 mr-2"></i> Opciones <i data-feather="chevron-down"
        ...
        <input id="id_user" type="hidden" value="{{ Auth::id() }}">
        <input id="token_user" type="hidden" value="{{ $tokenFlutter }}">

        <div class="overflow-x-auto scrollbar-hidden">
            {{-- <div class="mt-5 table-report table-report--tabulator" id="tabulator"></div> --}}
            {{-- <div>
            <div class="font-medium whitespace-no-wrap">nombre</div>
            <div class="text-xs text-gray-600 whitespace-no-wrap">categoria</div>
        </div> --}}
