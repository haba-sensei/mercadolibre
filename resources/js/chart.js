...
(function(cash) {
    ...
    if (cash("#pie-chart-widget").length) {
        window.addEventListener('load', () => {
            Livewire.emit('getbestsellers');
        });

        window.addEventListener('changebestsellers', e => {
            let datos = e.detail.data;
            let vendedores = e.detail.vendedores;
            ...
            let myPieChart = new chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: datos,
                        backgroundColor: ["#FF8B26", "#FFC533", "#285FD3", "#d32929", "#91c715"],
                        hoverBackgroundColor: ["#FF8B26", "#FFC533", "#285FD3", "#d32929", "#91c715"],
                        borderWidth: 5,
                        borderColor: cash("html").hasClass("dark") ?
                            "#303953" : "#fff",
                    }, ],
