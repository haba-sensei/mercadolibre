        ...
        <div class="col-span-12 lg:mx-auto lg:w-1/2 sm:w-full intro-y lg:col-span-12">
            <div class=" intro-y box">
                <div class="flex flex-col items-center p-5 border-b border-gray-200 sm:flex-row dark:border-dark-5">
                    <h2 class="mr-auto text-base font-medium">Editar Rol</h2>
                ...
                <div class="p-5" id="vertical-form">
                    ...
                    <div class="mb-4 preview" style="display: block; opacity: 1;">
                        ...
                        <div>
                            ...
                            {!! Form::text('name', null, ['class' => 'w-full mt-2 border input', 'placeholder' => 'Ingrese el Rol', 'autocomplete' => 'off', $role->name == "Alpha" ? 'disabled' : '']) !!}
                            @error('name')
                        ...
                        <div class="flex items-center ">
                            <div class="w-full pl-1 mb-4">
                                ...
                                {!! Form::checkbox('permissions[]', $permission->id, null, ['class' => 'float-right border input', $role->name == "Alpha" ? 'disabled' : '']) !!}
                            </div>
