...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="{{ mix('dist/js/web.js') }}" defer></script>
                        ...
                        <ul class="header__top-links">
                            ...
                            <li>
                                <div class="ps-dropdown language">
                                    <a href="#"><img src="{{ Storage::url('/flag/en.png') }}" alt="">English</a>
                                    <ul class="ps-dropdown-menu">
                                        <li>
                                            <a href="#"><img src="{{ Storage::url('/flag/germany.png') }}" alt=""> Germany</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ Storage::url('/flag/fr.png') }}" alt=""> France</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                                    ...
                                    <div class="ps-cart__items">
                                        <div class="ps-product--cart-mobile">
                                            <div class="ps-product__thumbnail">
                                                <a href="#"><img src="{{ Storage::url('/products/clothing/7.jpg') }}" alt=""></a>
                                            </div>
                                        ...
                                        <div class="ps-product--cart-mobile">
                                            <div class="ps-product__thumbnail">
                                                <a href="#"><img src="{{ Storage::url('/products/clothing/5.jpg') }}" alt=""></a>
                                            </div>
