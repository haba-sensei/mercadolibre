        ...
        <div class="intro-y box lg:mt-5">
            <div class="flex items-center p-5 border-b border-gray-200 dark:border-dark-5">
                <h2 class="mr-auto text-base font-medium">
                   Editar Orden de Categorias del Sistema ( Drag Orden )
                </h2>
            </div>
            ...
            <div class="p-5">
                ...
                <div class="intro-y">
                    <div class="flex items-center px-4 py-4 mb-3 box zoom-in" >
                        ...
                        <div class="px-2 py-1 text-xs font-medium text-white rounded-full cursor-pointer bg-theme-1" > Banner 1 </div>
                    </div>
                    ...
                    <div class="flex items-center px-4 py-4 mb-3 box zoom-in" >
                        ...
                        <div class="px-2 py-1 text-xs font-medium text-white rounded-full cursor-pointer bg-theme-1" > Banner 2 </div>
                    </div>
                    ...
                    <div class="flex items-center px-4 py-4 mb-3 box zoom-in" >
                        ...
                        <div class="px-2 py-1 text-xs font-medium text-white rounded-full cursor-pointer bg-theme-1" > Banner 3 </div>
                    </div>
